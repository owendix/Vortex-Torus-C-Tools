/* The defines through RNMX are for the random number generator */
/* Change this seed as desired: should be positive */
#define SEED        8

/* Do not change the following numbers. */
#define IA 16807
...
#define EPS 1.2e-7
#define RNMX (1.0-EPS)
/* End of group of numbers not to be changed. */
 
#include "ubiq.h"

float Rand()
/* From Numerical Recipes p 280 */
