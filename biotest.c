...
double TINY1=1e-14, TINY2=1e-12;
...
int main(){
	...
	int testinit=0;		//=1: starts colinear and same dir as l2
						//=0; starts colinear and opposite dir as l2
	int num=10000;		//How many evaluation points
	double factr = 1e-11;	//Factor to multiply by if ptspread=0
	double outdb, cntang=0.0, testfactr=3.0;
